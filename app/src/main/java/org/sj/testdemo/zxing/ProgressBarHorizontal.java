...
public class ProgressBarHorizontal extends View {
    ...
    public void setupParams(TypedArray typedArray) {
        ...
        maxProgress = typedArray.getInteger(R.styleable.ProgressBarHorizontal_pbhMaxProgress, 100);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (coverBitmap != null) {
            ...
            RectF coverRec = new RectF(0, 0, progressWidth < 2*coverRadius ? 2*coverRadius : progressWidth, h);
